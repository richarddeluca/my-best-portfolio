...
import { AirplaneInFlight, PaperPlane } from "phosphor-react";
...
export function ToDo() {
  ...
  const [listaDeTarefas, setListaDeTarefas] = useState<TaskData[]>([
    { key: v4(), isCompleted: false, title: 'Estudos', text: 'Ler algumas páginas do livro Rápido e Devagar' },
    { key: v4(), isCompleted: false, title: 'Meditação', text: 'Praticar um exercício do livro A Liberated Mind' },
    { key: v4(), isCompleted: false, title: 'Lazer', text: 'Acorda o Pedrinho, que hoje tem chocolate. Vem dançar calipso, vai ver cotio colhátio. don-don, dig-ri-don, don-don-don dig-dig-don, don , dig-ri-don, don-don-don dig-dig. - (John Lennon ft. Belchior)' },
    { key: v4(), isCompleted: true, title: 'Web Dev', text: 'Terminar de desenvolver ToDo App e postar no LinkedIn' },
  ])
  ...
  function handleCreateNewTodo(event: FormEvent) {
    ...
    const novaTarefa = { key: v4(), isCompleted: false, title: todoTitle, text: todoText }
